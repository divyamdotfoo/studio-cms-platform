...
export const metadata = {
  ...
  description:
    "Explore how traditional Uttarakhand architecture — stone walls, carved wooden jharokhas, and sloped roofs — inspires modern home design in Haridwar, Rishikesh, and Dehradun.",
};
