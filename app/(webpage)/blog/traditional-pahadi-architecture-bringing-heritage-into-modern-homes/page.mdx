...
export const metadata = {
  ...
  openGraph: {
    title: "Traditional Pahadi Architecture: Bringing Heritage Into Modern Homes",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 675,
        alt: "A traditional stone and timber hill house with carved wooden balcony and sloped slate roof",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "/blog/traditional-pahadi-architecture-bringing-heritage-into-modern-homes",
  },
};
