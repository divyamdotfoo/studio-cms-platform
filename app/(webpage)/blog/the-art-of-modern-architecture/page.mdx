...
export const metadata = {
  title: "The Art of Modern Architecture in Uttarakhand — Vision Architect",
  description:
    "How modern mountain home architecture in Uttarakhand blends materiality, light, and landscape. Design insights from Vision Architect in Haridwar.",
};
