...
export const metadata = {
  ...
  description:
    "A practical guide on blending Vastu Shastra principles with contemporary architecture for homeowners in Haridwar, Rishikesh, and Dehradun. Designed by Vision Architect.",
};
