...
export const metadata = {
  ...
  description:
    "Practical monsoon-proof home construction tips for Uttarakhand. Learn how to protect your home in Rishikesh, Haridwar, and Dehradun from heavy rains, seepage, and humidity.",
};
