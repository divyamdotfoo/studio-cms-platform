...
export function ServicesPage({ services }: ServicesPageProps) {
  return (
    <main>
      <section className="pt-24 lg:pt-28 pb-16 lg:pb-24" aria-label="Services">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-5 lg:px-10">
          <header className="mb-10 lg:mb-14">
            <h1 className="font-serif text-[clamp(1.8rem,8vw,3.6rem)] lg:text-[clamp(2.4rem,5vw,4.2rem)] leading-none tracking-[-0.02em] text-ink mb-5 sm:mb-6">
              <span className="block">Design Services</span>
            ...
            <p className="text-[14px] sm:text-[15px] lg:text-base leading-[1.75] sm:leading-[1.8] text-stone max-w-[620px]">
              Explore the services we offer for homes and interior spaces. Pick
              a category to see detailed variants, timelines, and practical
              specifications.
            </p>
          </header>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-4 sm:p-5 flex flex-col h-full">
                  ...
                  <div className="mt-auto inline-flex items-center gap-3 text-xs uppercase tracking-widest text-ink">
